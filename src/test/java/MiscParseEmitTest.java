...
public class MiscParseEmitTest {
    ...
    public void testTestsEmit() throws Exception {
        ...
        java.lang.reflect.Method method = tests.Emit.class.getDeclaredMethod("hasMember", com.github.javaparser.ast.body.ClassOrInterfaceDeclaration.class, String.class);
