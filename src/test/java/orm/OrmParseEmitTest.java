...
public class OrmParseEmitTest {
    ...
    public void testEmitNew() {
        ...
        user.properties.put("id", new Schema() {{ type = "string"; format = "uuid"; }});
        user.properties.put("active", new Schema() {{ type = "boolean"; }});
        user.properties.put("1invalid", new Schema() {{ type = "string"; }});
        user.properties.put("enum", new Schema() {{ type = "string"; }});
        user.properties.put("const", new Schema() {{ type = "string"; }});
        user.properties.put("default", new Schema() {{ type = "string"; }});
        user.properties.put("class", new Schema() {{ type = "string"; }});
        user.properties.put("age", new Schema() {{ type = "integer"; }});
        user.properties.put("longAge", new Schema() {{ type = "integer"; format = "int64"; }});
        user.properties.put("dVal", new Schema() {{ type = "number"; }});
        user.properties.put("fVal", new Schema() {{ type = "number"; format = "float"; }});
        user.properties.put("bytes", new Schema() {{ type = "string"; format = "binary"; }});
        user.properties.put("ld", new Schema() {{ type = "string"; format = "date"; }});
        user.properties.put("odt", new Schema() {{ type = "string"; format = "date-time"; }});
        user.properties.put("str", new Schema() {{ type = "string"; }});
        ...
        childMapSchema.additionalProperties = new Schema() {{ type = "string"; }};
        user.properties.put("childSpecMap", childMapSchema); // map<string, string>
        
        Schema arraySchema = new Schema();
        arraySchema.type = "array";
        arraySchema.items = new Schema() {{ type = "string"; }};
    ...
    public void testEmitExisting() {
        ...
        user.properties.put("newField", new Schema() {{ type = "string"; }});
        user.properties.put("existingField", new Schema() {{ type = "string"; }});
        api.components.schemas.put("User", user);
    ...
    public void testResolveTypeNotSchema() {
        ...
        user.properties.put("addPropNotSchema", new Schema() {{ type = "object"; additionalProperties = "StringVal"; }});
