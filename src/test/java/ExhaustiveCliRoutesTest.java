...
public class ExhaustiveCliRoutesTest {
    ...
    public void testCliMainReflection() throws Exception {
        ...
        try { processInMemory.invoke(null, "{"); } catch (Exception e) {}
        try { processInMemory.invoke(null, "{\"command\": \"to_openapi\"}"); } catch (Exception e) {}
        ...
        try { startStdioJsonRpcServer.invoke(null); } catch (Exception e) {}
        System.setIn(oldIn);
        cli.Main.main(new String[]{});
        cli.Main.main(new String[]{"-v"});
        cli.Main.main(new String[]{"--version"});
        try { cli.Main.main(new String[]{"process_in_memory"}); } catch (Exception e) {}
        try { cli.Main.main(new String[]{"invalid_cmd"}); } catch (Exception e) {}
        ...
        try { extractOpenAPI.invoke(null, new java.io.File("non_existent_file.json")); } catch (Exception e) {}
