...
public class Emit {
    ...
    public static String toString(OpenAPI api) {
        ...
        if (api.info != null) {
            ...
            if (api.info.version != null) infoObj.put("version", api.info.version);
            if (api.info.description != null) infoObj.put("description", api.info.description);
        ...
        if (api.paths != null && api.paths.pathItems != null) {
            ...
            for (Map.Entry<String, PathItem> e : api.paths.pathItems.entrySet()) {
                ...
                if (pi.get != null) piObj.put("get", serializeOperation(pi.get));
                if (pi.post != null) piObj.put("post", serializeOperation(pi.post));
                if (pi.put != null) piObj.put("put", serializeOperation(pi.put));
                if (pi.delete != null) piObj.put("delete", serializeOperation(pi.delete));
                if (pi.patch != null) piObj.put("patch", serializeOperation(pi.patch));
    ...
    private static JSONObject serializeOperation(Operation op) {
        ...
        if (op.operationId != null) obj.put("operationId", op.operationId);
        if (op.summary != null) obj.put("summary", op.summary);
        if (op.description != null) obj.put("description", op.description);
        ...
        if (op.requestBody != null && op.requestBody instanceof RequestBody) {
            ...
            if (rb.description != null) rbObj.put("description", rb.description);
            if (rb.required != null) rbObj.put("required", rb.required);
            if (rb.content != null) {
        ...
        if (op.responses != null && op.responses.statusCodes != null) {
            ...
            for (Map.Entry<String, Object> _re : op.responses.statusCodes.entrySet()) {
                ...
                if (_re.getValue() instanceof Response) {
                    ...
                    if (re_v.description != null) rObj.put("description", re_v.description);
    ...
    private static JSONArray serializeParameters(java.util.List<Object> params) {
        ...
        for (Object objP : params) {
            if (!(objP instanceof Parameter)) continue;
            Parameter p = (Parameter) objP;
            JSONObject pObj = new JSONObject();
            if (p.name != null) pObj.put("name", p.name);
            if (p.in != null) pObj.put("in", p.in);
            if (p.description != null) pObj.put("description", p.description);
            if (p.required != null) pObj.put("required", p.required);
    ...
    private static JSONObject serializeSchema(Schema s) {
        ...
        if (s.format != null) obj.put("format", s.format);
        if (s.description != null) obj.put("description", s.description);
        if (s.$ref != null) obj.put("$ref", s.$ref);
